...
- [ ] Phase 6 — dbt
  ...
  - [x] `dim_aircraft` / `fact_aircraft_state` (`models/marts/core/`) —
        star schema on top of `int_aircraft_activity`. `dim_aircraft` is
        built as an aggregate over observations (first/last seen, most
